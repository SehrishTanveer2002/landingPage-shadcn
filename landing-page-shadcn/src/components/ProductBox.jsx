...
const ProductBox = ({ image, title }) => {
  return (
    <div className="productbox bg-white w-[440px] sm:w-[420px] md:w-[320px] h-[475px] m-5 rounded-lg overflow-hidden transition-all duration-400 ease-in-out relative hover:shadow-[5px_5px_40px_rgba(255,103,2,0.336)]  group">
      <div className="productbox-img w-full h-[60%] ">
        <img src={image} alt={title} className="w-full h-full p-4 mt-10 object-contain" />
      </div>
      <div className="productbox-text w-full h-[30%] bg-white flex justify-center items-center text-center flex-col">
        <h2 className="text-[#3d2514] mb-2 text-xl font-semibold">{title}</h2>
